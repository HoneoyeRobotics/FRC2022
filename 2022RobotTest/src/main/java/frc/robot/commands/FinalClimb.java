...
public class FinalClimb extends SequentialCommandGroup {
  /** Creates a new MoneyAround. */
  public FinalClimb(OuterClimber outerClimber, InnerClimber innerClimber, LeadScrew leadScrew) {
